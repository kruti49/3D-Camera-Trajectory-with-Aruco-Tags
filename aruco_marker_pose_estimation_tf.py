...
class ArucoNode(Node):
  ...
  def __init__(self):
    ...
    # Declare parameters
    self.declare_parameter("aruco_dictionary_name", "DICT_5X5_100")
    self.declare_parameter("aruco_marker_side_length", 0.0785)
    self.declare_parameter("camera_calibration_parameters_filename", "/home/oem/dev_cs/src/opencv_tools/opencv_tools/calibration_chessboard.yaml")
